...
export const socialLinks = [
  ...
  { name: "Instagram", url: "https://instagram.com/alexmorgan.dev", icon: "Instagram" },
  { name: "YouTube", url: "https://youtube.com/@alexmorgan", icon: "Youtube" },
  { name: "Linktree", url: "https://linktr.ee/alexmorgan", icon: "Link" }
];
...
export const projects = [
  {
    ...
    title: "DevFlow",
    category: "Apps",
    description: "A collaborative development workflow platform with real-time code reviews and automated testing pipelines.",
    ...
    featured: true,
    details: {
      problem: "Development teams struggle with fragmented code review processes and manual testing workflows.",
      role: "Lead Developer & Architect",
      features: ["Real-time collaboration", "Automated CI/CD pipelines", "Smart code analysis", "Team analytics dashboard"],
      outcomes: "Reduced code review time by 40% and improved team productivity by 25%."
    }
  },
  {
    id: 2,
    title: "PackageKit",
    category: "Packaging",
    description: "Universal package manager CLI tool supporting NPM, PyPI, and Docker registries with unified commands.",
    ...
    featured: true,
    details: {
      problem: "Developers need to remember different commands for different package managers.",
      role: "Creator & Maintainer",
      features: ["Unified CLI interface", "Cross-platform support", "Smart dependency resolution", "Offline mode"],
  ...
  },
  {
    ...
    title: "API Forge",
    category: "Tools",
    description: "Visual API testing and documentation tool with automated mock server generation.",
  ...
  },
  {
    ...
    title: "DeployScript",
    category: "Scripts",
    description: "Zero-config deployment automation scripts for modern web applications across multiple cloud providers.",
  ...
  },
  {
    ...
    category: "Tools",
    description: "Production-ready admin dashboard template with 50+ components and dark mode support.",
  ...
  },
  {
    ...
    title: "CloudSync CLI",
    category: "Scripts",
    description: "Command-line tool for syncing local files with multiple cloud storage providers simultaneously.",
...
export const openSourceRepos = [
  {
    ...
    description: "Curated list of awesome developer tools, libraries, and resources for modern web development.",
    language: "Markdown",
    stars: 12500,
    forks: 890,
  ...
  },
  {
    id: 2,
    name: "fast-router",
    description: "Lightning-fast HTTP router for Node.js with zero dependencies and full TypeScript support.",
    language: "TypeScript",
    stars: 3400,
    forks: 210,
  ...
  },
  {
    ...
    description: "Predictable state management for React using finite state machines with hooks API.",
    language: "JavaScript",
    stars: 2100,
    forks: 145,
  ...
  },
  {
    ...
    description: "Production-ready Docker Compose templates for popular tech stacks and databases.",
    language: "Shell",
    stars: 1800,
    forks: 320,
  ...
  },
  {
    ...
    description: "Blazing fast JSON Schema validator with detailed error messages and custom validators.",
    language: "Go",
    stars: 980,
    forks: 67,
...
export const timeline = [
  ...
  },
  {
    ...
    company: "DevCorp",
    description: "Developed internal tools and automation scripts, reducing deployment time by 60%."
  },
  {
    year: "2015-2019",
